...
export default function EjemploUseState() {
    ...
    return (
        <div>
            ...
            <h2>Numero: {numero}</h2>
            <button onClick={() => setNumero(numero + 1)} className={"bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"}>Aumentar</button>
            <h2>Nombre: {nombre}</h2>
            <button onClick={() => setNombre("Pedro")} className={"bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"}>Cambiar Nombre</button>
            ...
            }} className={"bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"}>Añadir numero</button>
        </div>
    );
}